  ...
  func getSleepSummary(_ dateString: String,
    ...
    let query = HKSampleQuery(sampleType: sleepType, predicate: predicate, limit: HKObjectQueryNoLimit, sortDescriptors: [sortDescriptor]) { _, samples, error in
      ...
      resolve([
        ...
        "totalInBedHours": totalInBed / 3600.0,
        "deepSleepHours": deepSleep / 3600.0,
        "remSleepHours": remSleep / 3600.0,
        "coreSleepHours": coreSleep / 3600.0,
        "sleepEfficiency": efficiency,
        "bedTime": bedTime != nil ? self.dateFormatter.string(from: bedTime!) : NSNull(),
        "wakeTime": wakeTime != nil ? self.dateFormatter.string(from: wakeTime!) : NSNull(),
        "hasData": true
      ])
    }
